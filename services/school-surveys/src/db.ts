...
export interface SchoolSurveysDb {
...
export class SchoolSurveysSqlite implements SchoolSurveysDb {
  ...
  static async create(dbPath: string): Promise<SchoolSurveysSqlite> {
    const engine = new SchoolSurveysSqlite(dbPath);
...
export async function runSchoolSurveysMigrations(
  db: SchoolSurveysDb,
