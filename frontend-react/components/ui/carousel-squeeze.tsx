...
function Arrow({
    ...
    return (
        <button
            ...
            onClick={onClick}
            className={cn(
                "grid size-11 min-h-11 min-w-11 cursor-pointer place-items-center rounded-md",
...
function Action({ slide, shown }: { slide: SqueezeSlide; shown: boolean }) {
    ...
    const dress = cn(
        "group/sq-action inline-flex min-h-11 shrink-0 cursor-pointer items-center gap-2 rounded-md",
