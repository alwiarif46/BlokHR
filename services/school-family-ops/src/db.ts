...
export interface SchoolFamilyOpsDb {
...
export class SchoolFamilyOpsSqlite implements SchoolFamilyOpsDb {
  ...
  static async create(dbPath: string): Promise<SchoolFamilyOpsSqlite> {
    const engine = new SchoolFamilyOpsSqlite(dbPath);
...
export async function runSchoolFamilyOpsMigrations(
