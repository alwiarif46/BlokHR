...
import type { SchoolAttendanceService, MarkStatus } from '../school-attendance-service';
...
export function createSchoolAttendanceRouter(service: SchoolAttendanceService): Router {
  const router = Router();
