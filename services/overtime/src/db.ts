...
export class OvertimeSqlite implements OvertimeDb {
  ...
  static async create(dbPath: string): Promise<OvertimeSqlite> {
    const engine = new OvertimeSqlite(dbPath);
...
export async function runOvertimeMigrations(
  db: OvertimeDb,
