...
export interface SchoolTransportDb {
...
export class SchoolTransportSqlite implements SchoolTransportDb {
  ...
  static async create(dbPath: string): Promise<SchoolTransportSqlite> {
    const engine = new SchoolTransportSqlite(dbPath);
...
export async function runSchoolTransportMigrations(
  db: SchoolTransportDb,
