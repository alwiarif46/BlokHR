...
/**
 * @deprecated Azure Face path — frozen. Do not add features here.
 * New face capture uses on-device embeddings + `services/capture` (`@blokhr/capture`)
 * under jurisdiction/entitlement gates. Prefer Capture Admin + blokhr-capture app.
 *
 * Face recognition routes (legacy):
