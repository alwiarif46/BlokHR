...
export const IDENTITY_ROUTE_POLICIES: RoutePolicy[] = [
  ...
  {
    method: 'GET',
    pattern: /^\/[^/]+\/internal\/students\/[^/]+\/guardians\/?$/,
    roles: [],
    internalOnly: true,
  },
  {
    method: 'GET',
    pattern: /^\/[^/]+\/internal\/sections\/[^/]+\/guardians\/?$/,
    roles: [],
    internalOnly: true,
  },
  ...
  {
    method: 'POST',
    pattern: /^\/[^/]+\/guardians\/[^/]+\/invitations\/?$/,
    roles: OFFICE_UP,
  },
  {
    method: 'POST',
    pattern: /^\/[^/]+\/guardians\/[^/]+\/sessions\/revoke\/?$/,
    roles: OFFICE_UP,
    guardianOk: true,
  },
  { method: 'GET', pattern: /^\/[^/]+\/invitations\/?$/, roles: OFFICE_UP },
  {
    method: 'POST',
    pattern: /^\/[^/]+\/invitations\/[^/]+\/revoke\/?$/,
    roles: OFFICE_UP,
  },
  {
    method: 'GET',
    pattern: /^\/[^/]+\/guardian\/students\/[^/]+\/consents\/?$/,
    roles: [],
    guardianOk: true,
  },
  {
