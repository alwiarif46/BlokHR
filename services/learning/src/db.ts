...
/** Lightweight sql.js wrapper owned by the learning service. */
export class LearningSqlite implements LearningDb {
  ...
  static async create(dbPath: string): Promise<LearningSqlite> {
    const engine = new LearningSqlite(dbPath);
...
export async function runLearningMigrations(
  db: LearningDb,
