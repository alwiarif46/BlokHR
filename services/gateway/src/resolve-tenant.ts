 ...
 * Shared by gateway and monolith (keep in sync with backend/src/tenant/resolve-tenant.ts).
 */
 ...
 * Order: TENANT_HOST_MAP[X-Forwarded-Host|Host] → trusted X-Blok-Tenant → fallback.
 */
