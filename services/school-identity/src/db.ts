...
export interface SchoolIdentityDb {
...
/**
 * Lightweight sql.js wrapper owned by the school-identity service.
 */
export class SchoolIdentitySqlite implements SchoolIdentityDb {
  ...
  static async create(dbPath: string): Promise<SchoolIdentitySqlite> {
    const engine = new SchoolIdentitySqlite(dbPath);
...
export async function runSchoolIdentityMigrations(
  db: SchoolIdentityDb,
