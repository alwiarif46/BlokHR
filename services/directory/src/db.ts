...
/** Lightweight sql.js wrapper owned by the directory service. */
export class DirectorySqlite implements DirectoryDb {
  ...
  static async create(dbPath: string): Promise<DirectorySqlite> {
    const engine = new DirectorySqlite(dbPath);
...
export async function runDirectoryMigrations(
  db: DirectoryDb,
