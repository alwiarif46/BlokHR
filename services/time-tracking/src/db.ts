...
export class TimeTrackingSqlite implements TimeTrackingDb {
  ...
  static async create(dbPath: string): Promise<TimeTrackingSqlite> {
    const engine = new TimeTrackingSqlite(dbPath);
...
export async function runTimeTrackingMigrations(
  db: TimeTrackingDb,
