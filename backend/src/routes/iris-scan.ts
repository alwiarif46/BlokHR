...
/**
 * @deprecated Monolith iris path — frozen. Do not add features here.
 * Migrate templates into `services/capture` under `capture_iris_students` + DPIA/guardian consent.
 *
 * Iris Scan routes (legacy):
