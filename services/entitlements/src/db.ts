...
/**
 * Lightweight sql.js wrapper owned by the entitlements service.
 */
export class EntitlementsSqlite implements EntitlementsDb {
  ...
  static async create(dbPath: string): Promise<EntitlementsSqlite> {
    const engine = new EntitlementsSqlite(dbPath);
...
export async function runEntitlementsMigrations(
  db: EntitlementsDb,
