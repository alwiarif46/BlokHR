...
export interface SchoolLibraryDb {
...
export class SchoolLibrarySqlite implements SchoolLibraryDb {
  ...
  static async create(dbPath: string): Promise<SchoolLibrarySqlite> {
    const engine = new SchoolLibrarySqlite(dbPath);
...
export async function runSchoolLibraryMigrations(
  db: SchoolLibraryDb,
